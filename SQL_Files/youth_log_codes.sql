...
CREATE TABLE `log_codes` (
  ...
  PRIMARY KEY (`SIN`,`logCode`),
  CONSTRAINT `fk_LOG_CODES` FOREIGN KEY (`SIN`) REFERENCES `professional` (`SIN`)
...
INSERT INTO `log_codes` VALUES (123456789,1),(123456789,3),(123456789,10),(223456789,1),(223456789,3),(223456789,10),(323456789,1),(323456789,3),(323456789,10);
