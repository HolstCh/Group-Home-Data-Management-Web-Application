...
--
-- Table structure for table `pediatrician`
--

DROP TABLE IF EXISTS `pediatrician`;
...
CREATE TABLE `pediatrician` (
  ...
  PRIMARY KEY (`SIN`),
  CONSTRAINT `fk_PEDIATRICIAN` FOREIGN KEY (`SIN`) REFERENCES `professional` (`SIN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pediatrician`
--
